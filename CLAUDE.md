...
3. **APIDelta** (projects/apidelta/) — LAUNCHING + **V2 IN PLANNING**. Community-launched 2026-04-15. As of 2026-04-28 (Day 13): ~13 visitors/7d, 0 signups, 0 MRR — well below the original Day 30 survival floor. Rather than kill on pre-V2 metrics, the May 15 / Day 30 checkpoint was **deferred 2026-04-28** in favor of pushing the product to a V2 with a real moat (curated API catalog, MCP server, workflow integrations, named competitor compare pages, "why not just build this?" content). New post-V2 checkpoint criteria + 4-phase build plan live in `projects/apidelta/docs/v2-tracker.md`. Hard kill backstop: $0 MRR 60 days post-V2 launch.
