# Iteration 17: Fresh 2026 Signals Scan

**Date**: 2026-04-05
**Strategy**: Multi-source signal hunting — Reddit/HN/PH 2026 demand signals, indie hacker revenue patterns, G2 complaints, compliance deadline windows. Explicitly trying to find gaps missed in 16 prior iterations.

---

## Sources Scanned

- HN "Ask HN" threads (developer tools wishlist 2026, predictions 2026)
- Product Hunt developer tool launches (Jan-Apr 2026)
- Indie Hackers revenue milestones and solo founder playbooks
- SaaSify, EntrepreneurLoop, Medium listicles aggregating Reddit/HN signals
- SaaStr macro analysis (SaaSpocalypse, AI-native efficiency)
- G2 overpriced software complaints
- Compliance deadline calendar (EU AI Act, California DROP)

## Ideas Evaluated (8 total — all killed)

| Idea | Kill Reason |
|------|-------------|
| Enterprise Compliance Questionnaire Automation | 13+ tools (Conveyor, Breeze, 1up, Vanta, Tribble) — killed previously |
| EU AI Act Content Labeling Widget | AIComply + 13 competitors, deadline-driven churn — killed previously |
| AI API Spend Metering/Dashboard | CostLayer $9/mo, StackSpend, 10+ tools — killed previously |
| CI Smart Test Selector | Launchable acquired by CloudBees ($12.7M raised). Trunk $28.5M from a16z. Datadog Test Impact Analysis native. CircleCI building natively. Platform absorption. |
| Automated SOP Generator | 9+ tools (Waybook, Trainual, Scribe, Tango). Saturated. |
| Dunning/Subscription Recovery | 8+ tools (Churnkey, Churnbuster, Butter). Stripe commoditizing. Killed previously. |
