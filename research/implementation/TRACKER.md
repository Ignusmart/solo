...
Last updated: 2026-04-05 (iteration 19)

## Active Ideas

| # | Idea | Type | Folder | Status | Phase | Last Iteration | Blockers |
|---|------|------|--------|--------|-------|---------------|----------|
| 1 | DriftWatch — API dependency change monitor | SaaS | projects/driftwatch/ | POLISHING | Phase 3 | 2026-04-05 (#19) | DB URL + Stripe keys + domain needed for production deploy |
| 2 | ScanAble — Accessibility Report | Tool | projects/scanable/ | BUILDING | Phase 2 | 2026-04-05 (#4) | None |
