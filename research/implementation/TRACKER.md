...
Last updated: 2026-04-05 (iteration 23)

## Active Ideas

| # | Idea | Type | Folder | Status | Phase | Last Iteration | Blockers |
|---|------|------|--------|--------|-------|---------------|----------|
| 1 | DriftWatch — API dependency change monitor | SaaS | projects/driftwatch/ | LAUNCHING | Launch B | 2026-04-05 (#23) | Manual: domain, Neon DB, Stripe products, deploy — then run $200 Google Ads test |
| 2 | ScanAble — Accessibility Report | Tool | projects/scanable/ | POLISHING | Phase 3 | 2026-04-05 (#8) | None |
