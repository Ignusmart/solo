...
|---|------|------|--------|--------|-------|---------------|----------|
| 1 | DriftWatch — API dependency change monitor | SaaS | projects/driftwatch/ | POLISHING | Phase 3 | 2026-04-05 (#15) | DB URL + Stripe keys + domain needed for production deploy |
