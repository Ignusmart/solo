...
Last updated: 2026-04-05 (iteration 16)

## Active Ideas

| # | Idea | Type | Folder | Status | Phase | Last Iteration | Blockers |
|---|------|------|--------|--------|-------|---------------|----------|
| 1 | DriftWatch — API dependency change monitor | SaaS | projects/driftwatch/ | POLISHING | Phase 3 | 2026-04-05 (#16) | DB URL + Stripe keys + domain needed for production deploy |
| 2 | ScanAble — Accessibility Report | Tool | projects/scanable/ | PLANNING | — | 2026-04-05 (#1) | None |
